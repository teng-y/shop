        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="saleAttr in spuSaleAttrList" :key="saleAttr.id">
                ...
                <dd
                  ...
                  @click="handlerActive(saleAttrValue,saleAttr.spuSaleAttrValueList)"
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <a href="javascript:" @click="addSku2Cart">加入购物车</a>
              </div>
            </div>
          </div>
        </div>
...
import { reqAddOrUpdateCart } from "../../api/index";
...
export default {
  ...
  mounted() {
    // console.log(this.id);
    this.$store.dispatch("detail/getGoodDetailInfoData", this.id);
  },
  computed: {
  ...
  watch: {
    count(newValue) {
      // if(newValue<1) this.count=1
      // if(newValue>200) this.count=200
  ...
  methods: {
    handlerActive(current, parentAttr) {
